...
For Thought:
	...
	2) Each time we get or post data to the server, we check for errors before processing the response. However, we don't actually handle any errors if they occur. 